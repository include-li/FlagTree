...
@g.jit
def fused_qnorm_rope_kv_insert_kernel_ba34c6d87e(q, kv, k_cache, slot_mapping, position_ids, cos_sin_cache, eps, cache_block_size: gl.constexpr, num_tokens: gl.constexpr, num_heads: gl.constexpr, kv_block_stride, num_tokens_insert: gl.constexpr):
    ...
    if not __h81.to_auto(is_kv):
        ...
        variance = __h81.freeze(__h81.to_auto(gl.sum(__h81.concrete(__h81.to_auto(q_blk) * __h81.to_auto(q_blk), _layout=gl.BlockedLayout([1], [64], [1], [0])))) / __h81.to_auto(HEAD_DIM), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    ...
    kv_quant_blk0 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk1 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk2 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + 2 * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk3 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + 3 * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk4 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + 4 * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk5 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + 5 * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    kv_quant_blk6 = __h81.freeze(__h81.load(__h81.to_auto(kv_base) + 6 * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    qblock_idx = __h81.freeze(0)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk0).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    exponent = __h81.freeze(gl.ceil(__h81.to_auto(log_scale)))
    scale = __h81.freeze(gl.exp2(__h81.to_auto(exponent)))
    x_scaled = __h81.freeze(__h81.to_auto(kv_quant_blk) / __h81.to_auto(scale), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    x_clamped = __h81.freeze(_ext_fused_qnorm_rope_kv_insert_kernel_ba34c6d87e_tl.clamp(__h81.to_auto(x_scaled), -__h81.to_auto(FP8_MAX), __h81.to_auto(FP8_MAX)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    x_fp8 = __h81.freeze(__h81.to_auto(x_clamped).to(gl.float8e4nv), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    x_uint8 = __h81.freeze(__h81.to_auto(x_fp8).to(gl.uint8, bitcast=True), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    __h81.store(__h81.to_auto(token_fp8_ptr) + __h81.to_auto(qblock_idx) * __h81.to_auto(QUANT_BLOCK) + __h81.to_auto(offset_quant), __h81.to_auto(x_uint8), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    encoded_scale = __h81.freeze(__h81.to_auto(exponent) + 127.0)
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(1)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk1).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    ...
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(2)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk2).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    ...
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(3)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk3).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    ...
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(4)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk4).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    ...
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(5)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk5).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
    ...
    encoded_scale = __h81.freeze(gl.maximum(gl.minimum(__h81.to_auto(encoded_scale), 255.0), 0.0))
    __h81.store(__h81.to_auto(token_scale_ptr) + __h81.to_auto(qblock_idx), __h81.to_auto(encoded_scale).to(gl.uint8))
    qblock_idx = __h81.freeze(6)
    kv_quant_blk = __h81.freeze(__h81.to_auto(kv_quant_blk6).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(__h81.to_auto(gl.max(__h81.concrete(gl.abs(__h81.to_auto(kv_quant_blk)), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    block_max = __h81.freeze(gl.maximum(__h81.to_auto(block_max), 0.0001), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    raw_scale = __h81.freeze(__h81.to_auto(block_max) / __h81.to_auto(FP8_MAX))
    log_scale = __h81.freeze(gl.log2(__h81.to_auto(raw_scale)))
...
KERNEL = fused_qnorm_rope_kv_insert_kernel_ba34c6d87e
