...
# Provenance: results/gluon/gluon_baseline/loop_m1_n8192_bfloat16_t8192_w4.json
...
def add_rms_norm_loop_kernel_eacf48e03b(out_ptr, in_ptr1, in_ptr2, w_ptr, N, eps, TILE_N: gl.constexpr):
    ...
    for step in range(0, __h81.to_auto(num_steps) - 1):
        ...
        x1 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr1) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), _layout=gl.BlockedLayout([8], [64], [4], [0])).to(gl.float32), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x2 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr2) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), _layout=gl.BlockedLayout([8], [64], [4], [0])).to(gl.float32), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x = __h81.freeze(__h81.to_auto(x1) + __h81.to_auto(x2), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    ...
    n_offsets = __h81.freeze(__h81.to_auto(start_n) + __h81.arange(0, __h81.to_auto(TILE_N)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    mask = __h81.freeze(__h81.compare(__h81.to_auto(n_offsets), __h81.to_auto(N), 'lt'), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    x1 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr1) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([8], [64], [4], [0])).to(gl.float32), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    x2 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr2) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([8], [64], [4], [0])).to(gl.float32), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    x = __h81.freeze(__h81.to_auto(x1) + __h81.to_auto(x2), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    acc = __h81.freeze(__h81.to_auto(acc) + __h81.to_auto(x) * __h81.to_auto(x), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    ...
    for start_n in range(0, __h81.to_auto(TILE_N), __h81.to_auto(TILE_N)):
        ...
        mask = __h81.freeze(__h81.compare(__h81.to_auto(n_offsets), __h81.to_auto(N), 'lt'), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x1 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr1) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [4], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x2 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr2) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [4], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x = __h81.freeze(__h81.to_auto(x1) + __h81.to_auto(x2), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        ...
        y = __h81.freeze((__h81.to_auto(x) * __h81.to_auto(rrms) * __h81.to_auto(w)).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), __h81.to_auto(y), mask=__h81.to_auto(mask), _layout=gl.BlockedLayout([8], [64], [4], [0]))
    for start_n in range(__h81.to_auto(TILE_N), __h81.to_auto(N), __h81.to_auto(TILE_N)):
        n_offsets = __h81.freeze(__h81.to_auto(prev_multiple) - __h81.to_auto(start_n) + __h81.arange(0, __h81.to_auto(TILE_N)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x1 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr1) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [4], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x2 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr2) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [4], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        x = __h81.freeze(__h81.to_auto(x1) + __h81.to_auto(x2), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        ...
        y = __h81.freeze((__h81.to_auto(x) * __h81.to_auto(rrms) * __h81.to_auto(w)).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [4], [0]))
        __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), __h81.to_auto(y), _layout=gl.BlockedLayout([8], [64], [4], [0]))
