...
# Provenance: results/gluon/07/add_rms_norm_w1_s1_082617045006.json
...
def add_rms_norm_w1_s1(out_ptr, in_ptr1, in_ptr2, w_ptr, y_stride_r, y_stride_c, x1_stride_r, x1_stride_c, x2_stride_r, x2_stride_c, N, eps, BLOCK_SIZE: gl.constexpr):
    ...
    mask = __h81.freeze(__h81.compare(__h81.arange(0, __h81.to_auto(BLOCK_SIZE), layout=gl.BlockedLayout([1], [64], [1], [0])), __h81.to_auto(N), 'lt'), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    cols = __h81.freeze(__h81.arange(0, __h81.to_auto(BLOCK_SIZE)))
    x1 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr1) + __h81.to_auto(cols) * __h81.to_auto(x1_stride_c), __h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [1], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    x2 = __h81.freeze(__h81.load(__h81.to_auto(in_ptr2) + __h81.to_auto(cols) * __h81.to_auto(x2_stride_c), __h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [1], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    x = __h81.freeze(__h81.to_auto(x1) + __h81.to_auto(x2), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    var = __h81.freeze(__h81.to_auto(gl.sum(__h81.concrete(__h81.to_auto(x) * __h81.to_auto(x), _layout=gl.BlockedLayout([1], [64], [1], [0])), axis=0)) / __h81.to_auto(N), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    rrms = __h81.freeze(1 / gl.sqrt(__h81.to_auto(var) + __h81.to_auto(eps)))
    w = __h81.freeze(__h81.load(__h81.to_auto(w_ptr) + __h81.arange(0, __h81.to_auto(BLOCK_SIZE)), mask=__h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [1], [0])), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    y = __h81.freeze((__h81.to_auto(x) * __h81.to_auto(rrms) * __h81.to_auto(w)).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([1], [64], [1], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(cols) * __h81.to_auto(y_stride_c), __h81.to_auto(y), mask=__h81.to_auto(mask), _layout=gl.BlockedLayout([1], [64], [1], [0]))
