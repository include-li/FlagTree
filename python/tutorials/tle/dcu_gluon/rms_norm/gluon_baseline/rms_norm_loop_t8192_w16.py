...
# Provenance: results/gluon/gluon_baseline/rms_norm_loop_t8192_w16.json
...
def rms_norm_loop_kernel_8fe498e841(out_ptr, INV_RMS, in_ptr, w_ptr, N, eps, TILE_N: gl.constexpr):
    ...
    n_offsets = __h81.freeze(__h81.to_auto(start_n) + __h81.arange(0, __h81.to_auto(TILE_N), layout=gl.BlockedLayout([1], [64], [16], [0])), _layout=gl.BlockedLayout([8], [64], [16], [0]))
    ...
    for start_n in range(0, __h81.to_auto(TILE_N), __h81.to_auto(TILE_N)):
        ...
        mask = __h81.freeze(__h81.compare(__h81.to_auto(n_offsets), __h81.to_auto(N), 'lt'), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        x = __h81.freeze(__h81.load(__h81.to_auto(in_ptr) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [16], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        w = __h81.freeze(__h81.load(__h81.to_auto(w_ptr) + __h81.to_auto(n_offsets), mask=__h81.to_auto(mask), other=0.0, _layout=gl.BlockedLayout([8], [64], [16], [0])), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        x_normed = __h81.freeze((__h81.to_auto(x) * __h81.to_auto(rrms)).to(__h81.pointer_element_type(__h81.to_auto(in_ptr), True)), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        y = __h81.freeze(__h81.to_auto(x_normed) * __h81.to_auto(w), _layout=gl.BlockedLayout([8], [64], [16], [0]))
    ...
    for start_n in range(__h81.to_auto(TILE_N), __h81.to_auto(N), __h81.to_auto(TILE_N)):
        n_offsets = __h81.freeze(__h81.to_auto(prev_multiple) - __h81.to_auto(start_n) + __h81.arange(0, __h81.to_auto(TILE_N)), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        x = __h81.freeze(__h81.load(__h81.to_auto(in_ptr) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(n_offsets), eviction_policy='evict_first', _layout=gl.BlockedLayout([8], [64], [16], [0])).to(__h81.to_auto(cdtype)), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        w = __h81.freeze(__h81.load(__h81.to_auto(w_ptr) + __h81.to_auto(n_offsets), _layout=gl.BlockedLayout([8], [64], [16], [0])), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        x_normed = __h81.freeze((__h81.to_auto(x) * __h81.to_auto(rrms)).to(__h81.pointer_element_type(__h81.to_auto(in_ptr), True)), _layout=gl.BlockedLayout([8], [64], [16], [0]))
        y = __h81.freeze(__h81.to_auto(x_normed) * __h81.to_auto(w), _layout=gl.BlockedLayout([8], [64], [16], [0]))
