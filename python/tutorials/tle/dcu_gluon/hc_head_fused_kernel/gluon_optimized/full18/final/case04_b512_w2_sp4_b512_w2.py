# Layout candidate: sp=4, warps=2; source=h1280_hc2_b1024_w4_s2_weuNone.py
...
def _hc_head_fused_kernel_5d609257b0(residual_ptr, fn_ptr, hc_scale_ptr, hc_base_ptr, out_ptr, T, H: gl.constexpr, rms_eps, hc_eps, residual_stride_t, fn_stride_m, out_stride_t, HC: gl.constexpr, BLOCK_H: gl.constexpr):
    ...
    for h_start in range(0, __h81.to_auto(H), __h81.to_auto(BLOCK_H)):
        ...
        if __h81.compare(__h81.to_auto(HC), 2, 'gt'):
            ...
            mix_acc0 = __h81.freeze(__h81.to_auto(mix_acc0) + __h81.to_auto(r2) * __h81.load(__h81.to_auto(fn_ptr) + 0 * __h81.to_auto(fn_stride_m) + 2 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0), _layout=gl.BlockedLayout([4], [64], [2], [0]))
            mix_acc0 = __h81.freeze(__h81.to_auto(mix_acc0) + __h81.to_auto(r3) * __h81.load(__h81.to_auto(fn_ptr) + 0 * __h81.to_auto(fn_stride_m) + 3 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0), _layout=gl.BlockedLayout([4], [64], [2], [0]))
            mix_acc1 = __h81.freeze(__h81.to_auto(mix_acc1) + __h81.to_auto(r2) * __h81.load(__h81.to_auto(fn_ptr) + 1 * __h81.to_auto(fn_stride_m) + 2 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0), _layout=gl.BlockedLayout([4], [64], [2], [0]))
            mix_acc1 = __h81.freeze(__h81.to_auto(mix_acc1) + __h81.to_auto(r3) * __h81.load(__h81.to_auto(fn_ptr) + 1 * __h81.to_auto(fn_stride_m) + 3 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0), _layout=gl.BlockedLayout([4], [64], [2], [0]))
