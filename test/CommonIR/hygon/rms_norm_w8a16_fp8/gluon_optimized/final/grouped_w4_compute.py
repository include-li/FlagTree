...
def grouped_w4_compute(out_ptr, in_ptr, w_ptr, w_scale_ptr, N, eps, GROUP_SIZE: gl.constexpr, NUM_GROUPS: gl.constexpr):
    ...
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(pid) * __h81.to_auto(N) + __h81.to_auto(offsets), __h81.to_auto(y), mask=__h81.to_auto(mask), _layout=gl.BlockedLayout([1, 16], [8, 8], [4, 1], [1, 0]))
