...
# Provenance: results/gluon/gluon_baseline/tail_96.json
    ...
    for local_i in range(__h81.to_auto(worker_idx), __h81.to_auto(gather_len), __h81.to_auto(num_workers)):
        ...
        if __h81.compare(__h81.to_auto(nope_dim) % __h81.to_auto(quant_block), 0, 'eq'):
            for qblock in gl.static_range(0, __h81.to_auto(n_quant_blocks)):
                qoffs = __h81.freeze(__h81.to_auto(qblock) * __h81.to_auto(quant_block) + __h81.arange(0, __h81.to_auto(quant_block)), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                x_u8 = __h81.freeze(__h81.load(__h81.to_auto(token_data) + __h81.to_auto(qoffs)), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                x_fp8 = __h81.freeze(__h81.to_auto(x_u8).to(gl.float8e4nv, bitcast=True).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                ...
                x = __h81.freeze(__h81.to_auto(x_fp8) * __h81.to_auto(scale), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            ...
            for qblock in gl.static_range(0, __h81.to_auto(n_quant_blocks) - 1):
                qoffs = __h81.freeze(__h81.to_auto(qblock) * __h81.to_auto(quant_block) + __h81.arange(0, __h81.to_auto(quant_block), layout=gl.BlockedLayout([1], [64], [4], [0])), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                x_u8 = __h81.freeze(__h81.load(__h81.to_auto(token_data) + __h81.to_auto(qoffs), _layout=gl.BlockedLayout([1], [64], [4], [0])), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                x_fp8 = __h81.freeze(__h81.to_auto(x_u8).to(gl.float8e4nv, bitcast=True).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                encoded = __h81.freeze(__h81.load(__h81.to_auto(scale_base) + __h81.to_auto(qblock)))
                scale = __h81.freeze(gl.exp2(__h81.to_auto(encoded).to(gl.float32) - 127.0))
                x = __h81.freeze(__h81.to_auto(x_fp8) * __h81.to_auto(scale), _layout=gl.BlockedLayout([1], [64], [4], [0]))
                __h81.store(__h81.to_auto(out_row) + __h81.to_auto(qoffs), __h81.to_auto(x).to(gl.bfloat16), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            qblock = __h81.freeze(__h81.to_auto(n_quant_blocks) - 1)
            qoffs = __h81.freeze(__h81.to_auto(qblock) * __h81.to_auto(quant_block) + __h81.arange(0, __h81.to_auto(quant_block)), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            qmask = __h81.freeze(__h81.compare(__h81.to_auto(qoffs), __h81.to_auto(nope_dim), 'lt'), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            x_u8 = __h81.freeze(__h81.load(__h81.to_auto(token_data) + __h81.to_auto(qoffs), mask=__h81.to_auto(qmask), other=0, _layout=gl.BlockedLayout([1], [64], [4], [0])), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            x_fp8 = __h81.freeze(__h81.to_auto(x_u8).to(gl.float8e4nv, bitcast=True).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            encoded = __h81.freeze(__h81.load(__h81.to_auto(scale_base) + __h81.to_auto(qblock)))
            scale = __h81.freeze(gl.exp2(__h81.to_auto(encoded).to(gl.float32) - 127.0))
            x = __h81.freeze(__h81.to_auto(x_fp8) * __h81.to_auto(scale), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            __h81.store(__h81.to_auto(out_row) + __h81.to_auto(qoffs), __h81.to_auto(x).to(gl.bfloat16), mask=__h81.to_auto(qmask), _layout=gl.BlockedLayout([1], [64], [4], [0]))
        ...
        for rblock in gl.static_range(0, __h81.to_auto(rope_dim), 64):
            ...
            rmask = __h81.freeze(__h81.compare(__h81.to_auto(roffs), __h81.to_auto(rope_dim), 'lt'), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            vals = __h81.freeze(__h81.load(__h81.to_auto(bf16_ptr) + __h81.to_auto(roffs), mask=__h81.to_auto(rmask), other=0.0, _layout=gl.BlockedLayout([1], [64], [4], [0])), _layout=gl.BlockedLayout([1], [64], [4], [0]))
            __h81.store(__h81.to_auto(out_row) + __h81.to_auto(nope_dim) + __h81.to_auto(roffs), __h81.to_auto(vals), mask=__h81.to_auto(rmask), _layout=gl.BlockedLayout([1], [64], [4], [0]))
