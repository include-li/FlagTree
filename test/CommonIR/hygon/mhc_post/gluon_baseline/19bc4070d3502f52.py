...
# Provenance: results/gluon/gluon_baseline/19bc4070d3502f52.json
...
def mhc_post_kernel_hc_mult_4_ea58f0f0f4(a_ptr, b_ptr, c_ptr, d_ptr, out_ptr, H: gl.constexpr, BLOCK_H: gl.constexpr):
    ...
    b0 = __h81.freeze(__h81.load(__h81.to_auto(b_ptr) + __h81.to_auto(b_base) + 0 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [8], [0])).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    b1 = __h81.freeze(__h81.load(__h81.to_auto(b_ptr) + __h81.to_auto(b_base) + 1 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [8], [0])).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    b2 = __h81.freeze(__h81.load(__h81.to_auto(b_ptr) + __h81.to_auto(b_base) + 2 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [8], [0])).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    b3 = __h81.freeze(__h81.load(__h81.to_auto(b_ptr) + __h81.to_auto(b_base) + 3 * __h81.to_auto(H) + __h81.to_auto(h_off), mask=__h81.to_auto(h_mask), other=0.0, _layout=gl.BlockedLayout([1], [64], [8], [0])).to(gl.float32), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    acc0 = __h81.freeze(__h81.to_auto(c0) * __h81.to_auto(d_vals) + __h81.to_auto(a00) * __h81.to_auto(b0) + __h81.to_auto(a10) * __h81.to_auto(b1) + __h81.to_auto(a20) * __h81.to_auto(b2) + __h81.to_auto(a30) * __h81.to_auto(b3), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    acc1 = __h81.freeze(__h81.to_auto(c1) * __h81.to_auto(d_vals) + __h81.to_auto(a01) * __h81.to_auto(b0) + __h81.to_auto(a11) * __h81.to_auto(b1) + __h81.to_auto(a21) * __h81.to_auto(b2) + __h81.to_auto(a31) * __h81.to_auto(b3), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    acc2 = __h81.freeze(__h81.to_auto(c2) * __h81.to_auto(d_vals) + __h81.to_auto(a02) * __h81.to_auto(b0) + __h81.to_auto(a12) * __h81.to_auto(b1) + __h81.to_auto(a22) * __h81.to_auto(b2) + __h81.to_auto(a32) * __h81.to_auto(b3), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    acc3 = __h81.freeze(__h81.to_auto(c3) * __h81.to_auto(d_vals) + __h81.to_auto(a03) * __h81.to_auto(b0) + __h81.to_auto(a13) * __h81.to_auto(b1) + __h81.to_auto(a23) * __h81.to_auto(b2) + __h81.to_auto(a33) * __h81.to_auto(b3), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 0 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.to_auto(acc0).to(gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 1 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.to_auto(acc1).to(gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 2 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.to_auto(acc2).to(gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([1], [64], [8], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 3 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.to_auto(acc3).to(gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([1], [64], [8], [0]))
