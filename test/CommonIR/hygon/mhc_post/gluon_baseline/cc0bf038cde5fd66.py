...
# Provenance: results/gluon/gluon_baseline/cc0bf038cde5fd66.json
...
def mhc_post_kernel_hc_mult_4_ea58f0f0f4(a_ptr, b_ptr, c_ptr, d_ptr, out_ptr, H: gl.constexpr, BLOCK_H: gl.constexpr):
    ...
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 0 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.cast(acc0, gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([2], [64], [4], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 1 * __h81.to_auto(H) + (__h81.to_auto(pid_h) * __h81.to_auto(BLOCK_H) + __h81.arange(0, __h81.to_auto(BLOCK_H), layout=gl.BlockedLayout([1], [64], [4], [0]))), __h81.cast(acc1, gl.bfloat16), mask=__h81.compare(__h81.to_auto(pid_h) * __h81.to_auto(BLOCK_H) + __h81.arange(0, __h81.to_auto(BLOCK_H), layout=gl.BlockedLayout([1], [64], [4], [0])), __h81.to_auto(H), 'lt'), _layout=gl.BlockedLayout([1], [64], [4], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 2 * __h81.to_auto(H) + __h81.to_auto(h_off), __h81.cast(acc2, gl.bfloat16), mask=__h81.to_auto(h_mask), _layout=gl.BlockedLayout([2], [64], [4], [0]))
    __h81.store(__h81.to_auto(out_ptr) + __h81.to_auto(out_base) + 3 * __h81.to_auto(H) + (__h81.to_auto(pid_h) * __h81.to_auto(BLOCK_H) + __h81.arange(0, __h81.to_auto(BLOCK_H), layout=gl.BlockedLayout([1], [64], [4], [0]))), __h81.cast(acc3, gl.bfloat16), mask=__h81.compare(__h81.to_auto(pid_h) * __h81.to_auto(BLOCK_H) + __h81.arange(0, __h81.to_auto(BLOCK_H), layout=gl.BlockedLayout([1], [64], [4], [0])), __h81.to_auto(H), 'lt'), _layout=gl.BlockedLayout([1], [64], [4], [0]))
